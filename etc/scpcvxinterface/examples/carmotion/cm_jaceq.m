...
%
%**************************************************************************
function  Jgfval = cm_jaceq( n, ac, uc, ec, ...% current value of variables
...
for k=1:n
    ...
    % value of jacobian
    Jrho1u    = ( rho2k*rho2k*tp1k1 - rho1k*rho2k*tp1k2 )/(sqrtrhok*sqrtrhok*sqrtrhok);
    Jrho2u    = ( rho1k*rho1k*tp1k2 - rho1k*rho2k*tp1k1 )/(sqrtrhok*sqrtrhok*sqrtrhok);
    ...
    Jg1uk = sigma1k*Jrho1u + sigma2k*Jrho2u ...
          + (rho2k*Jsigma2uk + rho1k*Jsigma1uk)/sqrtrhok;

    Jg1ek = (rho1k*Jsigma1ek + rho2k*Jsigma2ek)/sqrtrhok;  

    % compute Jacobian of g2
    Jg2uk = sigma1k*Jrho2u   - sigma2k*Jrho1u ...
          + (rho2k*Jsigma1uk - rho1k*Jsigma2uk)/sqrtrhok;

    Jg2ek = (rho2k*Jsigma1ek - rho1k*Jsigma2ek)/sqrtrhok;  
...
Jgfval = sparse( [ diag(Jgaval), Jguval, Jgeval ] );
