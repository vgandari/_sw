classdef EulerAngleDCMQuaternionAndEulerVectorConversionGUIApp < handle
%
% Usage:
%     app.EulerAngleDCMQuaternionAndEulerVectorConversionGUIApp

  properties
      AppPath = {'/EulerAngleDCMQuaternionAndEulerVectorConversionGUI'};
	  AppClass = 'EulerAngleDCMQuaternionAndEulerVectorConversionGUIApp';
	  AppHandle;
	  AppCount = 0;
      Increment = 1;
	  Decrement = 0;
  ...
  methods
    ...
    function obj = EulerAngleDCMQuaternionAndEulerVectorConversionGUIApp()      
    ...
    function startApp(obj)
        ...
        if nargout(@SpinCalcVis) == 0  
            eval('SpinCalcVis');
        else
			obj.AppHandle = eval('SpinCalcVis');   
        end 
        % Increment the reference count by one    
        EulerAngleDCMQuaternionAndEulerVectorConversionGUIApp.refcount(obj.Increment);
